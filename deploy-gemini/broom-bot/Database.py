...
class BroomBotDatabase:
    ...
    def get_booking(self, booking_code):
        ...
        # Query untuk mendapatkan booking terbaru dengan JOIN untuk mendapatkan nama technician dan dealer
        query = '''
            SELECT
                b.id,
                b.customer_name,
                b.customer_plate_number,
                b.start_time,
                b.end_time,
                b.status,
                ...
                b.booking_code
            FROM BOOKINGS b
            JOIN TECHNICIANS t ON b.id_technician = t.id
            JOIN DEALERS d ON b.id_dealer = d.id
        ...
        if booking:
            return {
                ...
                "end_time": booking[4],
                "status": booking[5],
                "technician_name": booking[6],
                "dealer_name": booking[7],
                "dealer_address": booking[8],
                "dealer_phone": booking[9],
            }
        else:
